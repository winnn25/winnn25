...
USER_NAME = os.environ['USER_NAME']  # 'winnn25'
...
def user_getter(username):
    ...
    print('DEBUG RESPONSE:', request.json())
...
if __name__ == '__main__':
    """
    Ashwin Kullanthaivel (winnn25)
    Adapted from Andrew6rant/Andrew6rant's neofetch-style profile README generator.
    """
    ...
    # Birthday: 25 May 2002
    age_data, age_time = perf_counter(daily_readme, datetime.datetime(2002, 5, 25))
